...
<?php echo $this->Form->create('StaffMaster'); ?>
        <table border='1' cellspacing="0" cellpadding="5" style="width:100%;margin-top: 10px;border-spacing: 0px;">
            ...
            <tr>
                <td style='background-color: #e8ffff;width:30%;'>メールアドレス<font color="red">*</font><br>※ログインIDとして使用します。</td>
                <td colspan="2">
                    <?php echo $this->Form->input('email1',array('label'=>false,'div'=>false,'style'=>'width:80%;')); ?>
                </td>
            </tr>
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>パスワード<font color="red">*</font><br>※２回入力</td>
                <td colspan="2">
                    <?php echo $this->Form->input('password',array('type' => 'password', 'label'=>false,'div'=>false,'style'=>'width:60%;')); ?><br>
                    <?php echo $this->Form->input('password',array('type' => 'password', 'label'=>false,'div'=>false,'style'=>'width:60%;')); ?>
                </td>
            </tr>
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>その他のメールアドレス（任意）</td>
                <td colspan="2">
                    <?php echo $this->Form->input('email2',array('label'=>false,'div'=>false,'style'=>'width:80%;')); ?>
                </td>
            </tr>
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>登録場所<font color="red">*</font></td>
                <td colspan="2">
                    <?php  
            ...
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>氏名（漢字）<font color="red">*</font></td>
                <td colspan="2">
            ...
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>氏名（フリガナ）<font color="red">*</font></td>
                <td colspan="2">
            ...
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>性別<font color="red">*</font></td>
                <td colspan="2">
                    <?php  
            ...
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>生年月日<font color="red">*</font></td>
                <td colspan="2">
            ...
            <!-- 住所 End -->
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>電話番号（メイン）<font color="red">*</font></td>
                <td colspan="2">
                    <?php echo $this->Form->input('telno1',array('label'=>false,'div'=>false,'style'=>'width:30%;')); ?>
                </td>
            </tr>
            <tr>
                <td style='background-color: #e8ffff;width:20%;'>電話番号（その他）</td>
                <td colspan="2">
