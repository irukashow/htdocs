...
<!--- スタッフマスタ更新履歴 START --->
<table id="staff_master" border="1" width="100%" cellspacing="0" cellpadding="5" bordercolor="#333333" align="center" style="font-size: 80%;">
  <tr class="col">
    <th width="5%"><?php echo $this->Paginator->sort('id',"ID");?></th>
    <th width="5%"><?php echo $this->Paginator->sort('username','ユーザーID');?></th>
    <th><?php echo $this->Paginator->sort('name_sei','更新者');?></th>
    <th><?php echo $this->Paginator->sort('class','所属');?></th>
    <th><?php echo $this->Paginator->sort('case_id','案件ID');?></th>
    <th><?php echo $this->Paginator->sort('case_name','案件名');?></th>
    <th><?php echo $this->Paginator->sort('order_name','オーダー名');?></th>
  ...
  <tr>
    ...
    <td><?php echo $data['LoginLogs']['case_id']; ?></td>
    <td><?php echo $data['LoginLogs']['case_name']; ?></td>
    <td><?php echo $data['LoginLogs']['order_name']; ?></td>
    <?php $status = $data['LoginLogs']['status']; ?>
    <td><?php echo $data_item[25][$status]; ?></td>
