                ...
                for ($i=1; $i<=$col; $i++) {
                    for ($d=1; $d<=31; $d++) {
                        ...
                        if ($i <= $col-5) {
                            ...
                            // ポイント
                            if (empty($point_arr2[$d][$i])) {
                                $data2[$i]['point'.$d] = '';
                            } else {
                                $data2[$i]['point'.$d] = implode(',', $point_arr2[$d][$i]);
                            }
                        } elseif ($i == $col-4) {
         ...
         */
            ...
            if (!empty($staff_cell) && $staff_cell[0][0] == $year.'-'.$month) {
                ...
                for($i=1; $i<=200; $i++) {
                    ...
                    for($d=1; $d<=31; $d++) {
                        $staff_ids[$d][$i] = $results['WorkTable']['d'.$d];     // スタッフID
                        $points[$d][$i] = $results['WorkTable']['point'.$d];     // ポイント
                        if (!empty($results['WorkTable']['d'.$d])) {
                            $staff_ids2[$d][$i] = explode(',', $results['WorkTable']['d'.$d]);
                            $staff_ids3[$d][$i] = $results['WorkTable']['d'.$d];
                        }
