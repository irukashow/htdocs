...
?>
                &nbsp;&nbsp;仮登録番号：<?=$data['StaffMaster']['id'] ?></font>
            </div>
                    ...
                    <?php } else { ?>
                                <a href="<?=IMGURL ?>/files/staff_prereg/<?=sprintf('%010d', $id) ?>/<?=$id ?>.<?=$data['StaffMaster']['pic_extension'] ?>" rel="lightbox">
                                    <img src='<?=IMGURL ?>/files/staff_prereg/<?=sprintf('%010d', $id) ?>/<?=$id ?>.<?=$data['StaffMaster']['pic_extension'] ?>' style='border:1px black solid; width:150px;'>
                                </a>
                    <?php } ?>
                            </td>
                        </tr>
                    ...
                    <table border='1' cellspacing="0" cellpadding="5" style="width:100%;margin-top: 10px;border-spacing: 0px;">
                        <tr>
                            <td style='background-color: #e8ffff;width:30%;'>電話番号（携帯）</td>
                            <td style='width:70%;'><?=$data['StaffMaster']['telno1'] ?></td>
                        </tr>
                        <tr>
                            <td style='background-color: #e8ffff;width:30%;'>電話番号（その他）</td>
                        ...
                        <tr>
                            <td style='background-color: #e8ffff;width:30%;'>メールアドレス<br>（その他）</td>
