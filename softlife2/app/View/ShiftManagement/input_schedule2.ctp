...
<?php echo $this->Form->submit('検　索', array('name' => 'search', 'div' => false, 'style' => 'display:none;')); ?>
                ...
                <!-- 選択中スタッフ -->
                 <table border='1' cellspacing="0" cellpadding="1" style='margin-top: 0px;margin-bottom: 5px;border-spacing: 0px;width:100%;'>
                     <tr>
                         <th colspan="4" style='background:#99ccff;text-align: center;'>選択スタッフ（社員）</th>
                     </tr>
                     <?php if (!empty($data2)) { ?>
                     <tr style="">
                ...
                <!-- スタッフ検索 -->
                    <tr style="background-color: #ddffff;">
                        ...
                        <td align="center" colspan="2" style="width:75%;">
                            <?php echo $this->Form->input('select_user',array('label'=>false,'div'=>false, 'options'=>$user_arr, 'empty'=>array(''=>'選択してください'), 'style'=>'width:95%;padding:3px;')); ?>
                        </td>
                        <td align="center" style="width:10%;">
                            <?php echo $this->Form->submit('選　択', array('name' => 'select', 'div' => false, 'style' => 'font-size:110%;padding: 5px 10px;')); ?>
                        </td>
                    </tr>
                    <?php if (!empty($datas1)) { ?>
    ...
    <table border='1' cellspacing="0" cellpadding="3" style="width:100%;margin-top: 0px;border-spacing: 0px;background-color: white;">
            <tr align="center">
                    <td style=''><a href="<?=ROOTDIR ?>/ShiftManagement/input_schedule2/<?=$uid ?>?date=<?php echo date('Y-m', strtotime($y .'-' . $m . ' -1 month')); ?>">&lt; 前の月</a></td>
                    ...
                    <td style=''><a href="<?=ROOTDIR ?>/ShiftManagement/input_schedule2/<?=$uid ?>?date=<?php echo date('Y-m', strtotime($y .'-' . $m . ' +1 month')); ?>">次の月 &gt;</a></td>
            </tr>
    </table>
    <!-- 月選択 END -->
