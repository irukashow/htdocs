	...
	xml.onload = function(data){
		...
		if(station_l != null){
			...
			for( i=0; i<station_l.length; i++){
				...
				document.form.s2.options[ii] = new Option(op_station_name,op_station_cd);	//***
			}
		}
	}
}