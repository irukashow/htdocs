...
redipsInit = function () {
	...
	rd.event.cloned = function () {
            ...
            if (rd.obj.innerHTML.match(/▶/) == null) {
                rd.obj.innerHTML = '<span style="color:red;vertical-align: 1px;">▶</span>'+rd.obj.innerHTML;
            }
            if (rd.objOld.innerHTML.match(/▶/) == null) {
                rd.objOld.innerHTML = '<span style="color:red;vertical-align: 1px;">▶</span>'+rd.objOld.innerHTML;
            }
	};
