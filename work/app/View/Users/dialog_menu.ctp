<div id="dialog_menu" data-role="dialog">
    <ul data-role="listview">
        ...
        <input type="button" value="スケジュール" data-icon="arrow-r" data-iconpos="right" onclick='location.href="<?=ROOTDIR ?>/users/schedule#page2"'>
        <input type="button" value="勤務関連" data-icon="arrow-r" data-iconpos="right" onclick='location.href="<?=ROOTDIR ?>/users/work#page3"'>
