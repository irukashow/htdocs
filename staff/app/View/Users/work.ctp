<div id="page3" data-role="page">
    ...
    <div data-role="content">
        <b>勤務関連</b>
        <p>以下の変更ができます。</p>
        <input type="button" value="１．勤怠入力" data-icon="arrow-r" data-iconpos="right" onclick='location.href="#address"'>
        <input type="button" value="２．給与確認" data-icon="arrow-r" data-iconpos="right" onclick='location.href="#contact"'>
