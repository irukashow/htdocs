...
<div id="home" data-role="page">
        ...
        <div data-role="content">
            ...
            <ul data-role="listview">
                ...
                <li class="toplist_menu1"><a href="<?=ROOTDIR ?>/users/message/1">メッセージ</a></li>
                <li class="toplist_menu1"><a href="<?=ROOTDIR ?>/users/schedule">スケジュール</a></li>
                <li class="toplist_menu1"><a href="<?=ROOTDIR ?>/users/work">勤務関連</a></li>
                <li class="toplist_menu1"><a href="<?=ROOTDIR ?>/users/profile">プロフィール</a></li>
