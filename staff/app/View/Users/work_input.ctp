    ...
    <div data-role="content" style="font-size: 100%;">
        ...
        <?php echo $this->Form->input('status', array('type'=>'hidden', 'value' => 1)); ?>
            <table border="1" cellspacing="0" cellpadding="5" width="100%">
                <tr>
                    <td align="center" style='background-color: #e8ffff;width:20%;'>日付</td>
                    <td align="center">
                ...
                <tr>
                    <td align="center" style='background-color: #e8ffff;width:20%;'>始業<br>時刻</td>
                ...
                <tr>
                    <td align="center" style='background-color: #e8ffff;width:20%;'>終業<br>時刻</td>
                    <td align="center">
                        <div class="yoko">
